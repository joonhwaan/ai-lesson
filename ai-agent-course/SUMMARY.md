...
## 개요
- **대상/형태**: 중상급 개발자 대상 8세션 심화 과정 + 초보자용 입문 과정(레슨 00~13)
...
| advanced/demos/02_langchain_agent.py | 5 | LangChain 버전 |
| advanced/demos/03_langgraph_agent.py | 6 | LangGraph 버전 |
